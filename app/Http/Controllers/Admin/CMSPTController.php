...
use App\Models\CMSPT;
use Exception;
use Illuminate\Http\Request;
use Illuminate\Pagination\LengthAwarePaginator;
use Illuminate\Support\Facades\DB;

class CMSPTController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            DB::commit();
            return to_route('admin.cms.pt')->with('success', 'added successfully');
        } catch (Exception $e) {
            DB::rollBack();
            dd($e);
        }
    ...
    public function destroy($id)
    {
        ...
        return back()->with('success', 'Pt Challan removed successfully');
    }
}
