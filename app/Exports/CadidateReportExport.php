...
class CadidateReportExport implements FromCollection, WithHeadings
{
    ...
    public function collection()
    {
        return $this->candidates->load('candidateDocuments', 'clientstate')->map(function ($candidate, $index) {
            ...
            return [
                ...
                'Employee Last Working Date (LWD)' => optional($candidate->employee_last_date)->format('d-m-Y'),
                ...
                'PT' => $candidate->pt,
                'Other Deduction' => $candidate->other_deduction,
                'Total Deduction' => $candidate->total_deduction,
                'Net_Take_Home_Salary - NTH (Gross_Salary - Total_Deduction)' => $candidate->take_home,
                ...
                'Cost_To_Company - CTC (Gross_Salary + Employer_Deduction)' => $candidate->ctc,
    ...
    public function headings(): array
    {
        return [
            ...
            'Contract Date',
            'Status',
            'Employee Last Working Date (LWD)',
            'Designation',
            'Department',
            'State',
            'Location',
            ...
            'Other Deduction',
            'Total Deduction',
            'Net_Take_Home_Salary - NTH (Gross_Salary - Total_Deduction)',
            'Employer PF',
            'Employer ESIC',
            'Employer LWF',
            'Mediclaim',
            'Cost_To_Company - CTC (Gross_Salary + Employer_Deduction)',
