<x-applayout>
    <x-admin.breadcrumb title=" New FFI Show Cause Letter" isBack="{{ true }}" />
                        ...
                        <div class="form-contents">
                            <div class="row">
                                ...
                                <x-forms.input label="Designation: " type="text" name="designation" id="designation"
                                    :required="true" size="col-lg-6 mt-2" readonly />
                                <x-forms.input label="Date: " type="date" name="date" id="date" :required="false"
                                    size="col-lg-6 mt-2" :value="old('date')" />
