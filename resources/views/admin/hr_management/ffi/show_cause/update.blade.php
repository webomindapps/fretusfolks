<x-applayout>
    <x-admin.breadcrumb title="Edit FFI Show Cause Letter" isBack="{{ true }}" />
                            ...
                            <div class="row">
                                <div class="col-lg-6 mt-2">
                                    ...
                                    <input type="text" id="ffi_emp_id" name="ffi_emp_id"
                                        value="{{ $show->emp_id }}" onchange="return fetchEmployeeDetails()" required>
                                ...
                                <x-forms.input label="Enter Employee Name: " type="text" name="emp_name"
                                    id="emp_name" :required="true" size="col-lg-6 mt-2" :value="$show->show_letter->emp_name" readonly />
                                <x-forms.input label="Designation: " type="text" name="designation" id="designation"
                                    :required="true" size="col-lg-6 mt-2" :value="$show->show_letter->designation" readonly />
                                <x-forms.input label="Date: " type="date" name="date" id="date"
                                    :required="false" size="col-lg-6 mt-2" :value="$show->date" />
                               
                                <x-forms.textarea label="Content: " type="text" name="content" id="content"
                                    :required="true" size="col-lg-12 mt-2" :value="$show->content" />
                            </div>
                            <div class="row">
