...
<body  class="body"
        ...
        <tbody>
            <tr>
                <td style="padding-left: 5%; padding-right: 5%;">
                    <img src="{{ asset('admin/images/ffi_header.jpg') }}" alt="Header">
                    <div>
                        <div style="color: #000; font-size: 21px; margin-top: 4%; margin-bottom: 0%;">
                            ...
                            <div
                                    ...
                                    <tbody>
                                        <tr>
                                            <td colspan="3"
                                                ...
                                                <p style="line-height: 1.8; font-size: 14px">
                                                    <b>To,<br>Mr./Mrs./Ms, {{ $showLetter->show_letter->emp_name }}</b><br>
                                ...
                                <br>
                                <div class="content" style="line-height: 2; font-size: 14px">
                                    <p style="line-height: 1.8; font-size: 14px"><b>Dear {{ $showLetter->show_letter->emp_name }},</b>
                                    </p>
                                </div>
                                <br>
    ...
    <img src="{{ asset('admin/images/ffi_fotter.jpg') }}" alt="Footer">
</body>
