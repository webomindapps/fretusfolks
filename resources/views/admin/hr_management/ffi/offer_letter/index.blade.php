<x-applayout>
    <x-admin.breadcrumb title=" FFI Offer Letters" />
    <div class="col-lg-12 mt-4">
        <div class="form-card">
            <div class="row mb-2">
                <div class="col-lg-5 my-auto text-end ms-auto">
                    <a href="{{ route('admin.ffi_offer_letter.create') }}" class="add-btn bg-success text-white">
                        New FFI Offer Letter
                    </a>
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            @endphp
            <x-table :columns="$columns" :data="$offer" :checkAll=true :bulk="route('admin.fhrms.bulk')" :route="route('admin.ffi_offer_letter')">
