                ...
                <td style="padding-left:5%;padding-right:5%;">
                    ...
                    <div style="color:#000;font-size: 21px;margin-top: 0%;margin-bottom: 5%;">
                        ...
                        <div
                            ...
                            <h1 style="font-size:18px;text-align:center;text-decoration: underline;">Appointment Letter
                            </h1>
                            <br>
                            ...
                            <tr>
                                <td style="padding-left:5%; padding-right:5%;">
                                    <div
                                        ...
                                        <img class="abc" src="{{ asset('admin/images/ffi_header.jpg') }}"
                                            style="">
                        ...
                        <tbody>
                            <tr>
                                <td style="padding-left:5%; padding-right:5%;">
                                    <div
                                        style="color: #000; font-family: Tahoma; font-size: 17px; line-height: 18px; text-align: justify;">
                                        <ol type="1" start="16" style="font-size:12px; line-height:1.8;">
                                            <li>
                                ...
                                <td style="padding-left:5%; padding-right:5%;">
                                    <div
                                        ...
                                        <p style="font-size:12px; line-height:1.8;">
                                            <span style="margin-left:0%;">You are requested to return the enclosed copy
                                                duly signed as a token of your acceptance of the terms and conditions of
                                                your employment.</span><br>
                                            <span style="margin-left:0%;">Hope that this will be the beginning of a long
                                                and successful career with us.</span>
                                        </p>
                                    ...
                                    <div
                                        ...
                                        <center>
                                            <table class="table table1" border="1"
                                                style="border-collapse:collapse;width:80%;margin-bottom:20px;">
                                                <tbody>
                                                    <tr>
                                                        <th
