<x-applayout>
    <x-admin.breadcrumb title=" New FFI Warning Letter" isBack="{{ true }}" />
    ...
    <div class="col-lg-12 pb-4">
        <div class="form-card px-md-3 px-2">
            <form action="{{ route('admin.ffi_warning.create') }}" method="POST" enctype="multipart/form-data"
                id="employeeForm">
                @csrf
                <div class="card mt-3">
                            ...
                            <div class="row">
                                <div class="col-lg-6 mt-2">
                                    ...
                                    <input type="hidden" id="fetchEmployeeRoute"
                                        data-url="{{ route('admin.get.employeeWarning.details', ['ffi_emp_id' => ':ffi_emp_id']) }}">
                                </div>
