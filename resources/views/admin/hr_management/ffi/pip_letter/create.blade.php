<x-applayout>
    <x-admin.breadcrumb title=" New FFI Pip Letter" isBack="{{ true }}" />
    ...
    <div class="col-lg-12 pb-4">
        <div class="form-card px-md-3 px-2">
            <form action="{{ route('admin.ffi_pip_letter.create') }}" method="POST" enctype="multipart/form-data"
                id="employeeForm">
                @csrf
                <div class="card mt-3">
                        ...
                        <div class="form-contents">
                            <div class="row">
                                <x-forms.input label="From: " type="text" name="from_name" id="from_name"
                                    :required="true" size="col-lg-6 mt-2" :value="old('from_name')" />
                                <div class="col-lg-6 mt-2">
                                    ...
                                    <input type="hidden" id="fetchEmployeeRoute"
                                        data-url="{{ route('admin.get.employeePip.details', ['ffi_emp_id' => ':ffi_emp_id']) }}">
                                </div>
