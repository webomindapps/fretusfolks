<x-applayout>
    <x-admin.breadcrumb title="Edit FFI Termination Letter" isBack="{{ true }}" />
    ...
    <div class="col-lg-12 pb-4">
        <div class="form-card px-md-3 px-2">
            <form action="{{ route('admin.ffi_termination.edit', $termination->id) }}" method="POST" enctype="multipart/form-data"
                id="employeeForm">
                @csrf
                <div class="card mt-3">
                    <div class="card-header header-elements-inline d-flex justify-content-between align-items-center">
                        <h5 class="card-title mb-0">Edit Termination Letter Details</h5>
                    </div>
                    <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-lg-6 mt-2">
                                    ...
                                    <input type="text" id="ffi_emp_id" name="ffi_emp_id"
                                        value="{{ $termination->emp_id }}" onchange="return fetchEmployeeDetails()" required>
                                ...
                                <x-forms.input label="Enter Employee Name: " type="text" name="emp_name"
                                    id="emp_name" :required="true" size="col-lg-6 mt-2" :value="$termination->term_letter->emp_name" readonly />
                                <x-forms.input label="Designation: " type="text" name="designation" id="designation"
                                    :required="true" size="col-lg-6 mt-2" :value="$termination->term_letter->designation" readonly />
                                <x-forms.input label="Date: " type="date" name="date" id="date"
                                    :required="false" size="col-lg-6 mt-2" :value="$termination->date" />
                                <x-forms.input label="Absent From Date: " type="date" name="absent_date"
                                    id="absent_date" :required="false" size="col-lg-6 mt-2" :value="$termination->absent_date" />
                                <x-forms.input label="Show Cause Notice Date: " type="date" name="show_cause_date"
                                    id="show_cause_date" :required="false" size="col-lg-6 mt-2" :value="$termination->show_cause_date" />
                                <x-forms.input label="Termination Date: " type="date" name="termination_date"
                                    id="termination_date" :required="false" size="col-lg-6 mt-2" :value="$termination->termination_date" />
                                <x-forms.textarea label="Content: " type="text" name="content" id="content"
                                    :required="true" size="col-lg-12 mt-2" :value="$termination->content" />
                            </div>
                            <div class="row">
