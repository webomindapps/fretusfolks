<x-applayout>
    <x-admin.breadcrumb title="CMS PF " :create="route('admin.cms.pf.create')" />
    ...
    <div class="row {{ count($challans) > 0 ? '' : 'd-none' }}">
        <div class="col-lg-12">
            ...
            @endphp
            <x-table :columns="$columns" :data="$challans" :checkAll=false :bulk="route('admin.cms.esic')" :route="route('admin.cms.pf')">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1"
                                    ...
                                    <li>
                                        <a class="dropdown-item"
                                            ...
                                            href="{{ route('admin.cms.pf.delete', $item) }}">
