<x-applayout>
    <x-admin.breadcrumb title="New Invoice Details" isBack="{{ true }}" />
    @if ($errors->any())
    ...
    <div class="form-card px-md-3 px-2">
        <form method="POST" class="formSubmit" action="{{ route('admin.fcms.cims.edit', $invoice) }}"
                ...
                <div class="col-lg-6 mt-4" id="form-group-state">
                    ...
                    <select class="form-select" name="service_location" id="location" onchange="get_client_gst();"
                        ...
                        @foreach ($locations as $location)
                            <option {{ $invoice->service_location == $location->state ? 'selected' : '' }}
                                value="{{ $location->state }}">{{ $location->states?->state_name }}</option>
                        @endforeach
                    </select>
                    ...
                    <select class="form-select" name="inv_month" required data-fouc>
                        ...
                        @foreach (range(1, 12) as $month)
                            ...
                            <option value="{{ $monthName }}"
                                {{ $invoice->inv_month == $monthName ? 'selected' : '' }}>
                                {{ $monthName }}
                            </option>
                        @endforeach
                    </select>
