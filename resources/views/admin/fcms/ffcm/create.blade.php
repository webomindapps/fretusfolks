<x-applayout>
    <x-admin.breadcrumb title="Fetus Folks Cost Management" />
    ...
    <div class="col-lg-12 pb-4">
        <div class="form-card px-md-3 px-2">
            <form action="{{ route('admin.fcms.ffcm.create') }}" method="POST" enctype="multipart/form-data"
                id="pendingDetailsForm">
                @csrf
                <div class="card mt-3">
                    <div class="card-header header-elements-inline d-flex justify-content-between align-items-center">
                        <h5 class="card-title mb-0">New Expenses Details</h5>
                    </div>
                    <div class="card-body">
                        <div class="form-contents">
                            <div class="row">
                                <x-forms.input label=" Date: " type="date" name="date" id="date"
                                    :required="true" size="col-lg-6 mt-2" :value="old('date')" />
                                ...
                                <x-forms.select label="Nature Of Expenses:" name="nature_expenses" id="nature_expenses"
                                    :required="true" size="col-lg-6 mt-2" :options="FretusFolks::getExpenses()" :value="old('nature_expenses')" />
                                <x-forms.input label="Amount: " type="number" name="amount" id="amount"
                                    :required="true" size="col-lg-6 mt-2" :value="old('amount')" />
                            </div>
                            <div class="row">
