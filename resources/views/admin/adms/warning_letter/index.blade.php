<x-applayout>
    ...
    <div class="row mt-2">
        <div class="d-flex justify-content-end align-items-center">
            <div class="d-flex gap-3">
                ...
                <form action="{{ route('admin.warning_letter.bulkimport') }}" method="POST" enctype="multipart/form-data"
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            @endphp
            <x-table :columns="$columns" :data="$warning" :checkAll=false :bulk="route('admin.ffi_warning.bulk')" :route="route('admin.warning_letter')">
