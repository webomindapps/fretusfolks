<x-applayout>
    <x-admin.breadcrumb title="Edit ADMS Warning Letter" isBack="{{ true }}" />
    ...
    <div class="col-lg-12 pb-4">
        <div class="form-card px-md-3 px-2">
            <form action="{{ route('admin.warning_letter.edit', $warning->id) }}" method="POST" enctype="multipart/form-data"
                id="employeeForm">
                @csrf
                <div class="card mt-3">
                        ...
                        <div class="form-contents">
                            <div class="row">
                                ...
                                <x-forms.input label="Enter Employee Name: " type="text" name="emp_name"
                                    id="emp_name" :required="true" size="col-lg-6 mt-2" :value="$warning->warningletter->emp_name" readonly />
                                <x-forms.input label="Designation: " type="text" name="designation" id="designation"
                                    :required="true" size="col-lg-6 mt-2" :value="$warning->warningletter->designation" readonly />
