<x-applayout>
    <x-admin.breadcrumb title=" Approved Candidates">
        <div class="d-flex justify-content-end align-items-center">
            <div class="d-flex gap-3">
                <a href="{{ asset('admin/approvedcandidates_formate.xlsx') }}"
                    download="ApprovedCandidates_Formate.xlsx" class="btn btn-primary text-white">
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            @endphp
            <x-table :columns="$columns" :data="$candidate" :checkAll=false :bulk="route('admin.cfis.bulk')"
                    ...
                    <td>
                        <div class="dropdown">
                            <button class="btn btn-secondary dropdown-toggle" type="button"
                                ...
                                {{ $item->dcs_approval == 1 ? 'Approved' : ($item->dcs_approval == 0 ? 'Pending' :
                                'Rejected') }}
                            </button>
