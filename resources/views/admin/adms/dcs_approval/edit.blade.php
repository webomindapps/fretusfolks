                        ...
                        <div class="form-contents">
                            <div class="row">
                                ...
                                <x-forms.input label="Enter Bank Account No::" type="text" name="bank_account_no"
                                    id="bank_account_no" :required="true" size="col-lg-6 mt-2"
                            ...
                            <div class="row">
                                <div class="col-lg-12 mt-4">
                                    ...
                                    <x-forms.button type="buton" label="Save" class="btn btn-primary" />
                                </div>
                            </div>
                        </div>
                    </div>
