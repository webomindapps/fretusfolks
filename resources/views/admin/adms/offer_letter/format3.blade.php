...
<body>
    ...
    <div style="margin:0 35 0">
        ...
        <div>
            <p style="font-size:14.2px;line-height:1.5;text-align:justify">
            ...
            <tbody>
               <tr>
                  <td>
                     <p style="font-size:14.2px;line-height:1.5;text-align:justify"><br>
                        <span>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
                <tbody>
                    <tr>
                        <td style="font-size:14.2px; text-align:left; padding-left:10px;">
