...
<body onload="window.print();">
    ...
    <div style="margin:0 35px">
        <p style="line-height:1.8;font-size:14px;font-family:times;">
            ...
            <span>Emp : <b>{{ $offerLetter->employee_id }}</b></span> <br>
    ...
    <div
        ...
        <p style="line-height:1.8;font-size:14px;font-family:times; ">
            <span>Date :
                <b>{{ \Carbon\Carbon::parse($offerLetter->joining_date)->format('d-m-Y') }}</b></span> <br>
        </p>
    </div>
    ...
    <div style="margin:0 35px">
        ...
        <ol type="1" style="font-size:12px;line-height:1.8;text-align:justify;margin-bottom:10px;">
            ...
            <li>
                ...
                probation if you are found guilty of activities such as Cash mismanagement, Theft, Bike Meter tampering,
            ...
            <li>
                Notwithstanding anything above, depending upon the afore mentioned project/work, the company reserves
                its right to extend your temporary appointment for such a period or periods as may be necessary
                depending upon the exigencies relatable to the work for which you are hereby engaged. The same shall be
                informed to you in advance. In the event, the company shall be in writing extend your temporary
                assignment on the terms as may be indicated in such extension of the assignment you shall be governed by
            ...
            <li>
                During the period of fixed contract of <b>{{ $offerLetter->tenure_month }}</b> months, your services
                could be
                deputed at the sole discretion of the management to any of our client’s company to do work pertaining to
            ...
            <li>
                ...
                you/outcome of the police verification report then this appointment will stand withdrawn immediately.
            </li>
            <li>
            ...
            <li>
                If you <b>did not report to work for continuous 3 days</b> without proper notification of absenteeism,
                company is liable to end your contract on immediate basis, on request from client.
            </li>
            <li>
                Client holds the discretion to do a through background verification of your candidature as seems fit and
                can initiate police verification, background check, court cases verification.
            </li>
            <li>
                If you found guilty in any one of them, Client have the full authority to end your contract immediately
            ...
            <li>
                ...
                which you have been deputed). You will receive your salary on {{ $offerLetter->salary_date }}th
                of every month.
            </li>
            <li>
            ...
            <li>
                You will be provided assets (mobile phone and uniform) during your work which has to be returned at the
                time of leaving company and on failing to submit the assets to the client amount will be deduct against
                the assets.
            </li>
        </ol>
        <p style="font-size:14px;line-height:1.5;text-align:justify">
            ...
            growth among all members to the <b>Fretus Folks India Pvt Ltd.</b> As a new entrant, we would like you to
            whole-heartedly contribute in this process.
        </p>
        <p style="font-size:14px;line-height:1.5;text-align:justify">
            As a token of acceptance of the above terms and conditions, you are requested to sign the duplicate copy of
            ...
            <tbody>
                <tr>
                    <td style="font-size:12px;text-align:left;margin-left:-5px;">
                        <br>
                        <p><b>For : Fretus Folks India Pvt Ltd.</b> <br></p>

                        &nbsp;&nbsp;&nbsp;<img src="{{ public_path('admin/images/seal.png') }}" style="margin-top:2%;"
                            width="100"><br>
                        <p>&nbsp;&nbsp;&nbsp;Authorized Signatory</b> <br></p> <b>
            ...
            <tbody>
                <tr>
                    <td colspan="3" style="font-size:12px;text-align:left;padding:7px">
                        ...
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img
                            src="{{ public_path('admin/images/seal.png') }}" width="100">
                        <br>
