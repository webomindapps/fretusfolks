...
<body onload="window.print();">
                ...
                <tr>
                    <td colspan="3" style="font-size:12px;text-align:left;padding:7px">
                        <p style="line-height:1.8;font-size:14px !important;">
                            <b>Offer No :</b> {{ $offerLetter->ffi_emp_id }} <br>
                        </p>
    ...
    <div style="margin:0 35px">
        ...
        <p style="line-height:1.8;font-size:14px">
            <b>For : Fretus Folks India Pvt Ltd.</b> <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img
                src="{{ public_path('admin/images/seal.png') }}" style="margin-top:2%;" width="100"><br>
        ...
        <div
            ...
            <p style="line-height:1.8;font-size:14px ;">
                ...
                <span style="margin-left:10%;">Offer No : {{ $offerLetter->ffi_emp_id }} <br></span>
            ...
            <table cellpadding="8px" class="table table1" border="1"
                ...
                <tbody>
                    <tr>
                        <th style="font-size:13px;text-align:center;padding:3px;border-top: 1px solid #000;">
                            Components
                        </th>
                        <th style="font-size:13px;text-align:center;padding:3px;width:30%;border-top: 1px solid #000;">
                            Monthly salary
                        </th>
                        <th style="font-size:13px;text-align:center;padding:3px;width:30%;border-top: 1px solid #000;">
                            Annual salary
                ...
                <tr>
                    <td colspan="3" style="font-size:14px;text-align:left;">
                        <p style="line-height:1.8;font-size:14px !important;margin:0;padding:0">
                            <b>Ref.No. :</b> {{ $offerLetter->ffi_emp_id }} <br>
                        </p>
                    </td>
        ...
        <p style="font-size:12px">
            <span>
                ...
                <br /><br />
                <p><b>Signature:<span
                            style="text-decoration:underline;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></b>
                </p><br /> <br />

                <b>Place:</b> <span style="font-size:12px">{{ $offerLetter->location }}</span> <br />
                <b>Date:</b> <span
                    style="font-size:12px">{{\Carbon\Carbon::parse($offerLetter->joining_date)->format('d-m-Y')
                    }}</span>
                <br />
            </span>
        </p>
