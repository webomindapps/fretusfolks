                    ...
                    <div class="card-body">
                        <div class="form-contents">
                            <div class="row">
                                ...
                                <x-forms.input label="FFI Employee ID:" type="text" name="employee_id" id="employee_id"
                                    :required="true" size="col-lg-6 mt-2" :value="old('employee_id')" />

                                <x-forms.select label="Enter Client Name:" name="company_id" id="company_id"
                                    :required="true" size="col-lg-6 mt-2" :options="FretusFolks::getClientname()"
                                    :value="old('company_id')" />
                                <x-forms.input label="Enter Employee Name: " type="text" name="emp_name" id="emp_name"
                                    :required="true" size="col-lg-6 mt-2" :value="old('emp_name')" />
                                <x-forms.input label="Joining Date: " type="date" name="joining_date" id="joining_date"
                                    :required="true" size="col-lg-6 mt-2" :value="old('joining_date')" />
                                {{-- <x-forms.input label="Contract End Date " type="date" name="contract_date"
                                    id="contract_date" :required="true" size="col-lg-6 mt-2"
                                ...
                                <x-forms.input label="Tenure Month(Integer): " type="text" name="tenure_month"
                                    id="tenure_month" :required="true" size="col-lg-6 mt-2"
                                    :value="old('tenure_month')" />
                                ...
                                <x-forms.input label="Email ID: " type="email" name="email" id="email" :required="true"
                                    size="col-lg-6 mt-2" :value="old('email')" />
                                <div class="form-group col-lg-6 mt-2">
                                    <label for="phone1">Phone: <span style="color: red">*</span></label>
                                    <input type="text" name="phone1" id="phone1" class="form-control" maxlength="10"
                                ...
                                <div style="border:
                                    ...
                                    <div class="row">
                                        ...
                                        <x-forms.input label="HRA: " type="number" name="hra" id="hra" :required="true"
                                            size="col-lg-4 mt-2" :value="old('hra')" />
                                        ...
                                        <x-forms.input label="Other Allowance: " type="number" name="other_allowance"
                                            id="other_allowance" :required="true" size="col-lg-4 mt-2"
                                            :value="old('other_allowance')" />
                                        <x-forms.input label="ST Bonus: " type="number" name="st_bonus" id="st_bonus"
                                            :required="true" size="col-lg-4 mt-2" :value="old('st_bonus')" />
                                        ...
                                        <x-forms.input label="Employee PF: " type="number" name="emp_pf" id="emp_pf"
                                            :required="true" size="col-lg-4 mt-2" :value="old('emp_pf')" />

                                        <x-forms.input label="Employee ESIC: " type="number" name="emp_esic"
                                            id="emp_esic" :required="true" size="col-lg-4 mt-2"
                                            :value="old('emp_esic')" />
                                        <x-forms.input label="Employee Lwf: " type="number" name="lwf" id="lwf"
                                            :required="true" size="col-lg-4 mt-2" :value="old('lwf', '0')" />
                                        <x-forms.input label="PT: " type="number" name="pt" id="pt" :required="true"
                                            size="col-lg-4 mt-2" :value="old('pt')" />
                                        <x-forms.input label="Other Deduction: " type="number" name="other_deduction"
                                            id="other_deduction" :required="true" size="col-lg-4 mt-2"
                                            :value="old('other_deduction')" />
                                        <x-forms.input label="Total Deduction: " type="number" name="total_deduction"
                                            id="total_deduction" :required="true" size="col-lg-4 mt-2"
                                            :value="old('total_deduction')" />
                                        <x-forms.input
                                        ...
                                        <x-forms.input label="Mediclaim: " type="number" name="mediclaim" id="mediclaim"
                                            :required="true" size="col-lg-3 mt-2" :value="old('mediclaim')" />
                                        <x-forms.input
                                            label="Cost To Company - CTC (Gross_Salary + Employer_Deduction): "
                                            type="number" name="ctc" id="ctc" :required="true" size="col-lg-12 mt-2"
                                            :value="old('ctc')" />
                                    </div>
                                </div>
                            </div>
