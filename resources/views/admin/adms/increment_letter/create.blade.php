<x-applayout>
    <x-admin.breadcrumb title=" New ADMS Increment Letter" isBack="{{ true }}" />
                        ...
                        <div class="form-contents">
                            <div class="row">
                                ...
                                <x-forms.textarea label="Content: " type="text" name="content" id="content"
                                    :editor="true" :required="true" size="col-lg-12 mt-2"
                                ...
                                <div style="border:
                                    ...
                                    <div class="row">
                                        ...
                                        <x-forms.input label="HRA: " type="number" name="hra" id="hra" :required="true"
                                            size="col-lg-3 mt-2" :value="old('hra')" />
                                        ...
                                        <x-forms.input label="Employee PF: " type="number" name="emp_pf" id="emp_pf"
                                            :required="true" size="col-lg-3 mt-2" :value="old('emp_pf')" />
                                        <x-forms.input label="ESIC Percentage: " type="number" name="esic_percentage"
                                            id="esic_percentage" :required="true" size="col-lg-3 mt-2"
                                            :value="old('esic_percentage')" />
                                        ...
                                        <x-forms.input label="PT: " type="number" name="pt" id="pt" :required="true"
                                            size="col-lg-3 mt-2" :value="old('pt')" />
                                        <x-forms.input label="Lwf: " type="number" name="lwf" id="lwf" :required="true"
                                            size="col-lg-3 mt-2" :value="old('lwf', '0')" />
                                        ...
                                        <x-forms.input label="Employer PF Percentage: " type="number"
                                            name="employer_pf_percentage" id="employer_pf_percentage" :required="true"
                                            size="col-lg-3 mt-2" :value="old('employer_pf_percentage')" />
                                        ...
                                        <x-forms.input label="Employer ESIC Percentage: " type="number"
                                            ...
                                            :value="old('employer_esic_percentage')" />
                                        ...
                                        <x-forms.input label="CTC: " type="number" name="ctc" id="ctc" :required="true"
                                            size="col-lg-3 mt-2" :value="old('ctc')" />
                                    </div>
                                </div>
                            </div>
                            <div class="row">
