<x-applayout>
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            @endphp
            <x-table :columns="$columns" :data="$letter_content" :bulk="route('admin.letter_content.bulk')" :checkAll=false :route="route('admin.letter_content')">
                @foreach ($letter_content as $key => $item)
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('admin.letter_content.edit', $item->id) }}">
