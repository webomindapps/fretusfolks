...
Route::prefix('admin')->group(function () {
    ...
    Route::middleware('auth')->group(function () {
        ...
        Route::post('/increment_letter/bulkimport', [AdmsIncrementLetterController::class, 'bulkUpload'])->name('increment_letter.bulkimport');
        ...
        Route::post('/warning_letter/bulkimport', [AdmsWarningLetterController::class, 'bulkUpload'])->name('warning_letter.bulkimport');
        ...
        Route::post('/showcause_letter/bulkimport', [AdmsShowcauseLetterController::class, 'bulkUpload'])->name('showcause_letter.bulkimport');
        ...
        Route::post('/termination_letter/bulkimport', [AdmsTerminationLetterController::class, 'bulkUpload'])->name('termination_letter.bulkimport');
